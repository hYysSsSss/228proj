...
\section{Conclusion}
This project implements a complete real-data benchmark for post-disaster building damage assessment. The experiments compare several segmentation and classification models, save all intermediate results, and directly address the requirement to use real data and stronger baselines. FCN-ResNet50 achieves the best segmentation result with 0.3189 mean IoU and 0.3957 mean Dice. ConvNeXt-Tiny with paired pre/post crops and augmentation achieves the best classification result with 0.7110 accuracy, 0.6716 macro-F1, and 0.7123 weighted-F1. The results support the conclusion that modern pretrained models and paired temporal imagery improve damage classification, while fine-grained damage severity remains a difficult open problem.
